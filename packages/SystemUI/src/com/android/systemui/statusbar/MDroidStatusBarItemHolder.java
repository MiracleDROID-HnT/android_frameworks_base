...
public class MDroidStatusBarItemHolder extends RelativeLayout
        implements MDroidStatusBarItem.Manager {
    private static final String TAG = "MDroidStatusBarItemHolder";

    private ArrayList<MDroidStatusBarItem.DarkReceiver> mDarkReceivers =
            new ArrayList<MDroidStatusBarItem.DarkReceiver>();
    private ArrayList<MDroidStatusBarItem.VisibilityReceiver> mVisibilityReceivers =
            new ArrayList<MDroidStatusBarItem.VisibilityReceiver>();
    ...
    public MDroidStatusBarItemHolder(Context context) {
        this(context, null);
    }

    public MDroidStatusBarItemHolder(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MDroidStatusBarItemHolder(Context context, AttributeSet attrs, int defStyle) {
    ...
    private DarkReceiver mDarkReceiver = new DarkReceiver() {
        ...
        public void onDarkChanged(Rect area, float darkIntensity, int tint) {
            ...
            mLastTint = tint;
            for (MDroidStatusBarItem.DarkReceiver r : mDarkReceivers) {
    ...
    private void updateVisibilityReceivers(boolean isVisible) {
        ...
        for (MDroidStatusBarItem.VisibilityReceiver r : mVisibilityReceivers) {
            r.onVisibilityChanged(mItemHolderIsVisible);
        }
    }

    // MDroidStatusBarItem.Manager methods

    public void addDarkReceiver(MDroidStatusBarItem.DarkReceiver darkReceiver) {
    ...
    public void addVisibilityReceiver(MDroidStatusBarItem.VisibilityReceiver visibilityReceiver) {
