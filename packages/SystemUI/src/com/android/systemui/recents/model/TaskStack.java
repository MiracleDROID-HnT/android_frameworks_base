...
public class TaskStack {
    ...
    public void removeTask(Task t, AnimationProps animation, boolean fromDockGesture,
            boolean dismissRecentsIfAllRemoved) {
        if (Recents.sLockedTasks.contains(t.key.baseIntent.getComponent().flattenToString())) {
            Recents.sLockedTasks.remove(t.key.baseIntent.getComponent().flattenToString());
        }
